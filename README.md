...
> **Compatibility:** this branch targets **Spring Boot 3.x / Jakarta EE / Java 17+**.
> For Spring Boot 2.x (javax, Java 11+), use the `main` line. The two are maintained as parallel
> artifacts so existing Boot 2 users aren't forced to migrate.
